...
fun createVerificationEntry(status: VerificationStatus? = null, vararg verificationEntries: Pair<String, VerificationEntry>): VerificationEntry = VerificationEntry().apply {
    this.status = status
